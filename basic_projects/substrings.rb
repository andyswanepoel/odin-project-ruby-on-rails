...
def substrings(string, dictionary)
  lower_strings = string.downcase
  dictionary.each_with_object({}) do |substring, out|
    count = lower_strings.scan(substring).length
    out[substring] = count if count.positive?
  end
end
